  ...
  const handleSubmitLogin = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://sneaker-head-1.adityarupdatta.repl.co/api/v1/login",
        {
          email,
          password,
        }
      ...
      switch (error.response.status) {
        ...
        case 404:
          ...
          break;
        case 500:
          toast.error(`The server has encountered a situation it does not know how to handle.`);
          break;
        case 503:
